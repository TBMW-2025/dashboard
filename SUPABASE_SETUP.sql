...
ALTER TABLE settings ADD COLUMN IF NOT EXISTS admin_username       VARCHAR(150) DEFAULT 'admin';
ALTER TABLE settings ADD COLUMN IF NOT EXISTS admin_email          VARCHAR(150) DEFAULT 'admin@rru.ac.in';
ALTER TABLE settings ADD COLUMN IF NOT EXISTS admin_mobile         VARCHAR(20)  DEFAULT '';
-- SHA-256 hex of 'Admin@123'
ALTER TABLE settings ADD COLUMN IF NOT EXISTS admin_password_hash  VARCHAR(64)  DEFAULT 'e86f78a8a3caf0b60d8e74e5942aa6d86dc150cd3c03338aef25b7d2d7e3acc7';
...
-- ─── 2. ADD MISSING COLUMNS TO PLACEMENTS ────────────────────────────────────
ALTER TABLE placements ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW();
...
CREATE TABLE IF NOT EXISTS internships (
    ...
    programme           VARCHAR(100),
    gender              VARCHAR(10),
    internship_place    VARCHAR(150),
    internship_place_02 VARCHAR(150),
